...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Course',
            fields=[
                ('code', models.AutoField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, unique=True)),
                ('email', models.EmailField(blank=True, max_length=100, null=True, unique=True, validators=[django.core.validators.EmailValidator(message='Enter a valid email address.'), main.models.validate_custom_email])),
                ('password', models.CharField(max_length=255, validators=[django.core.validators.MinLengthValidator(8), main.models.validate_custom_password])),
        ...
        migrations.CreateModel(
            name='Faculty',
            fields=[
                ('faculty_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=100, unique=True)),
                ('email', models.EmailField(blank=True, max_length=100, null=True, unique=True, validators=[django.core.validators.EmailValidator(message='Enter a valid email address.'), main.models.validate_custom_email])),
                ('password', models.CharField(max_length=255, validators=[django.core.validators.MinLengthValidator(8), main.models.validate_custom_password])),
